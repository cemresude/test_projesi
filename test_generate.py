...
with st.sidebar:
    ...
    model_type = st.selectbox("Model Seçin", ["models/gemini-1.5-flash", "models/gemini-pro", "models/gemini-2.0", "models/gemini-2.5-turbo", "models/gemini-3-pro-preview", "models/gemini-2.5-flash"])
